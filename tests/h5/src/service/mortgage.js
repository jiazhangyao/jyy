...
//申请书签字信息保存
export const mortgageApplicationSign = data => {
  return request({
    url: '/web/api/order/confirm/mortgageApplicationSign',
    method: "POST",
    data
  })
}
...
//详情接口
export const transferPretaxInfo = id => {
  return request('/web/api/order/query/detail/'+id, {
    method: 'GET',
  })
}
