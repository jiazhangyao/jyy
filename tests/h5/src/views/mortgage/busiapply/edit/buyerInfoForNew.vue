...
import { contractInfo, getMaterialList } from "@/service/mortgageBusiness";
import {
  ownershipTypeConst,
  holdingTypeConst,
  orgTypeConst,
  UserRoleEnum
} from "@/views/mortgage/busiapply/const";
import {
  newApplicantDTO,
  newApplicantInfoDTO,
  newFamilyMemberDTO
...
export default {
  ...
  mounted() {
    let mortgagorInfo = {
      ...newApplicantInfoDTO(),
      ...this.transferbusiapplyForm.mortgagorInfo
    };
    this.applicantList = mortgagorInfo.applicantList ? mortgagorInfo.applicantList : [];
    let orgType =
