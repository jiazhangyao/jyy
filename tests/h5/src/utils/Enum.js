 ...
 * @return {string} 对应的别名
 */
  getValueArrFromAliasArr(aliasArr) {
    return aliasArr.map(item => this.aliasIndex[item].value);
  }
  ...
  toSelectionObject() {
    ...
    let aaa = array.reduce((options, item) => {
