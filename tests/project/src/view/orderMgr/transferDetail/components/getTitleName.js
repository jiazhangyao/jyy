...
export function getTitleName(registerType) {
  //let tabItems = ["备案信息", "义务人", "权利人", "抵押权人", "产权信息", "抵押信息", "材料上传", "邮寄服务"];
  let tabItems = [{
    id: "baxx",
    title: "备案信息"
  },
...
export function getTitleTabs(registerType) {
  ...
  switch (+registerType) {
    ...
    case 15:
      ...
      break;
    default:
      tabItems = getTitleName(registerType)
      break;
